	...
	return (
        ...
        <ArrowLeftIcon className="0" width={24} height={24} /> <span>Back</span>
						...
						<div className="col-span-2">
							<div className="mb-3">
								<UserCircleIcon width={100} height={100} className="p-3 bg-slate-400/50 rounded-full m-auto block" />
							</div>
							<h1 className="text-2xl font-bold text-blue text-center">Upload Data</h1>
							<p className="text-lg text-slate-500 my-5 text-center">Please click the "Upload" button to proceed.</p>
						</div>
					</head>
						...
						<form action="" className="" onSubmit={handleSubmit}>
							...
							<div className="my-2 flex items-center justify-center p-3">
								<Link to={"/dashboard"} className="flex gap-2 text-slate-800">
									<ArrowLeftIcon className="0" width={24} height={24} /> <span>Cancel</span>
								</Link>
							</div>
						</form>
					</section>
